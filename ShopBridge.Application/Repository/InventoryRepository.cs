...
namespace ShopBridge.Application.Repository
{
    internal class InventoryRepository : IInventoryRepository
    {
        ...
        public InventoryRepository(ShopBridgeContext dbContext)
        {
        ...
        public async Task<InventoryModel> GetInventoryAsync(int id)
        {
            ...
            if (inventory == null)
                throw new NotFoundException(nameof(Inventory), nameof(Inventory.Id), id);
        ...
        public async Task<bool> UpdateInventoryAsync(InventoryModel inventory)
        {
            ...
            if (_inventory == null)
                throw new NotFoundException(nameof(Inventory), nameof(Inventory.Id), inventory.Id);
            ...
            dbContext.Entry(_inventory).State = EntityState.Modified;
